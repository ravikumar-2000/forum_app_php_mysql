...
<form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']) ?>" method="POST"class="mt-4 w-75">
  <div class="mb-3">
    ...
    <input type="text" class="form-control <?php echo $titleErr ? 'is-invalid' : null; ?>" id="name" name="title" placeholder="Enter title" value="<?php echo isset($_SESSION['updating_blog']['title'] ) ? $_SESSION['updating_blog']['title'] : null; ?>">
  ...
  <div class="mb-3">
    ...
    <textarea class="form-control <?php echo $blog_body_Err ? 'is-invalid' : null; ?>" id="blog_body" name="blog_body" placeholder="Write your thoughts"><?php echo isset($_SESSION['updating_blog']['body'] ) ? $_SESSION['updating_blog']['body'] : null; ?></textarea>
    <div class="invalid-feedback">
